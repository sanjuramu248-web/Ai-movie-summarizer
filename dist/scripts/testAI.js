...
async function testAI() {
    ...
    const plotTest = await (0, ai_service_1.generateAISummary)([
    ...
    const reviewsTest = await (0, ai_service_1.generateAISummary)([
    ...
    const emptyTest = await (0, ai_service_1.generateAISummary)([]);
